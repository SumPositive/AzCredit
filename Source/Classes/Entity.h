...
@property (nonatomic, retain) NSNumber	*nClosingDay;	// 締日 1〜28,99=末日, 0=Debit(自動引落し)	
...
@property (nonatomic, retain) NSNumber   *nReservType;	// (0)通常 (1)予約 (2)毎年 (3)毎月  [0.3]New
@property (nonatomic, retain) NSNumber   *sumNoCheck;	// e6parts.@sum.nNoCheck
@property (nonatomic, retain) NSString   *zName;
@property (nonatomic, retain) NSString	 *zNote;
...
@property (nonatomic, retain) NSSet		 *e6parts;		// E3 <-->> E6  [0.3].nReservType!=0 ⇒ nil
@end
