...
+ (void)list
{
	...
	NSMutableDictionary* result = [NSMutableDictionary dictionary]; // autorelease
	...
	[[NSNotificationCenter defaultCenter] postNotificationName:@"LocalhostAdressesResolved" 
														object:result];
	
	[pool release]; // resultは「通知」によりhttpInfoUpdateにてcopyされているので解放しても大丈夫。
}
